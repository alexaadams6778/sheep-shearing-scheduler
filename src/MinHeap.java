...
{
	private T[] heap;
	public static final int DEF_SIZE = 128;	//initial capacity
	...
	private void bubbleUp()		//private helper to bubble up the heap
	{
		int index = lastIndex;
	...
	private void bubbleDown()	//private helper to bubble down the heap
	{
		int index = 0;
	...
	public void heapSort(T[] array)		//sorts a given array
	{
		if(array == null)
			return;
